...
dataContext.addDynamicDocumentPropertyValues("ddp_sample", "ddp_sample-value-0") //First document is 0
...
// If setting DDPs for multiple files, then index needs to be set. Index range starts at 0.
dataContext.addDocumentPropertyValues("connector.track.disk.filename", "input-file-name-0") //First document is 0
